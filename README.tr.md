...
| `UserPromptSubmit` | `mod.js` | `??` / `++`de kütüphane bulguları, `pp`de özel kitaplar, `aa`da ajans koltukları — işaret cümlenin başında da sonunda da okunur; yoksa hiçbir şey |
