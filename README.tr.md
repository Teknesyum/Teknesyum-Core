...
```powershell
irm https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.1.1/install.ps1 | iex
```

### macOS / Linux — tek satır

```bash
curl -fsSL https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.1.1/install.sh | bash
```
...
kancanın bağlama yazmadığını doğrulayan 2.221 sınama.
...
- `docs/DECISIONS.md` — projeyi biçimlendiren yedi karar ve gerekçeleri
