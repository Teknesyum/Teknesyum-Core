...
```powershell
irm https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.39.0/install.ps1 | iex
```

### macOS / Linux - tek satır

```bash
curl -fsSL https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.39.0/install.sh | bash
```
...
```bash
git clone --depth 1 --branch v0.39.0 https://github.com/Teknesyum/Teknesyum-Core "$HOME/Teknesyum-Core"
```
