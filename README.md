...
2,262 assertions covering the guard, the completion gate, the audit chain, the ledger, the
...
- `docs/DECISIONS.md` — the fourteen decisions that shaped this and why
