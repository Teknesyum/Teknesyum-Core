...
```powershell
irm https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.44.0/install.ps1 | iex
```

### macOS / Linux - one line

```bash
curl -fsSL https://raw.githubusercontent.com/Teknesyum/Teknesyum-Core/v0.44.0/install.sh | bash
```
...
```bash
git clone --depth 1 --branch v0.44.0 https://github.com/Teknesyum/Teknesyum-Core "$HOME/Teknesyum-Core"
```
