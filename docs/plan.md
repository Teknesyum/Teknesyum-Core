...
- [ ] K3 Kanca hijyeni: aynı metni ikinci kez basma, bayt bütçesi testi, Windows `python3` stub, stdin boşaltma. İş kapısı: koşan arka plan ajanı geçerli gerekçe sayılsın (2026-09-11'de canlıda görüldü).
